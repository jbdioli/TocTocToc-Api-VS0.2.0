...
namespace TocTocToc.Views
{
    ...
    public partial class AdvertisingAddOrModifyPage : ContentPage
    {
        ...
        public AdvertisingAddOrModifyPage()
        {
            ...
            InitValues();
            InitAutoComplete();
            //GetAdvertisingData(advertisingView);
        ...
        private async void OnAddMedia(object sender, EventArgs e)
        {
            ...
            await _httpRequestChannelHandler.SaveHttpMediaAsync<AdvertisingDtoModel>(_advertisingView.Image);
        ...
        private async void OnUpdateMedia(object sender, EventArgs e)
        {
            ...
            var response = await _httpRequestChannelHandler.UpdateHttpMediaAsync<AdvertisingDtoModel>(_advertisingView.Image, _advertisingView.AdvertisingId);
